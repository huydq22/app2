  ...
  return (
    <SafeAreaView style={styles.container} edges={['top']}>
      ...
      <ScrollView style={styles.content}>
        <TouchableOpacity style={styles.menuItem} onPress={() => navigateTo('/guestRouter/faq')}>
        ...
        <TouchableOpacity style={styles.menuItem} onPress={() => navigateTo('/guestRouter/contact-feedback')}>
          <Ionicons name="mail-outline" size={24} color="#333" style={styles.menuIcon} />
          <Text style={styles.menuText}>Liên hệ & Phản hồi</Text>
          <Ionicons name="chevron-forward" size={20} color="#999" />
        </TouchableOpacity>

        <TouchableOpacity style={styles.menuItem} onPress={() => navigateTo('/guestRouter/privacy-policy')}>
        ...
        <TouchableOpacity style={styles.menuItem} onPress={() => navigateTo('/guestRouter/chat')}>
